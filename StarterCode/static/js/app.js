// create a path to pull the reference dataset to dropdown
function init() {
 ...
 // -------------------Start the dashboard------------------------//
//  Enable an option to fetch new data when different sample id's selected //
...
// plot.ly hw challenge completed  by Solomon Rotich......//